...
res_powder = powder_average(cryst, radii, 2000) do qs
    intensities(swt, qs; energies, kernel)
end
plot_intensities(res_powder; units, saturation=1.0, title="CoRh₂O₄ Powder Average")

nqfi_cryst = nqfi(res, cryst; prefactor=0.5)
fig = plot_nqfi(path, nqfi_cryst)
